...
(
    ...
    (
        ...
        't_alert4' => 'Inner error serevr',
        't_alert5' => 'Inner error serevr',
        't_alert6' => 'Inner error serevr',
    ),
    ...
    (
        ...
        'pop_var4' => '',
        'pop_var' => '',
        't_alert1' => 'Few cash, please top up your balance',//Недосточно средств, пожалуйста проверти баланс
        't_alert2' => 'Please login',//пожалуйста залогинтесть
        't_alert3' => 'Please game in one window',//Пожалуйста играйте только в одном окне
    ),
